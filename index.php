...
<body>
	<br>
	<div class="container mx-auto p-2 border" style="width: 800px;">
		<hr />
		<form method="post" enctype="multipart/form-data">
			<div class="col-md-4">
				...
				<button class="btn btn-primary" type="submit" name="submit" style="margin-left: 250px; width: 250px; margin-top: 15px;">Submit</button>
				<br>
				<br>
			</div>
		</form>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form method="post">
								...
								<button class="btn btn-primary" type="submit" name="edit" style="margin-left: 115px; width: 250px ;margin-top: 15px;">Submit</button>
							</form>
						</div>
					</div>
				</div>
